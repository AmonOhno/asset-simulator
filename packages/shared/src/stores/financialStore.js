...
const financialStore = (set, get) => {
    ...
    return ({
        ...
        getCalendarJournalEntries: async (startDate, endDate) => {
            const { userId } = useAuthStore.getState();
            if (!userId)
                return [];
            try {
        ...
        getRegularJournalEntries: async () => {
            const { userId } = useAuthStore.getState();
            if (!userId)
                return [];
            try {
        ...
        addRegularJournalEntry: async (entry) => {
            const { userId } = useAuthStore.getState();
            if (!userId)
                return;
            try {
        ...
        updateRegularJournalEntry: async (entry) => {
            const { userId } = useAuthStore.getState();
            if (!userId)
                return;
            try {
        ...
        deleteJournalAccount: async (account) => {
            const { userId } = useAuthStore.getState();
            if (!userId)
                return;
            try {
        ...
        deleteJournalEntry: async (entry) => {
            const { userId } = useAuthStore.getState();
            if (!userId)
                return;
            try {
        ...
        deleteRegularJournalEntry: async (entry) => {
            const { userId } = useAuthStore.getState();
            if (!userId)
                return;
            try {
        ...
        executeRegularJournalEntry: async (entry) => {
            const { userId } = useAuthStore.getState();
            if (!userId)
                return;
            try {
        ...
        executeDueRegularJournalEntries: async () => {
            const { userId } = useAuthStore.getState();
            if (!userId)
        ...
        getBalanceSheetView: async (asOfDate) => {
            const { userId } = useAuthStore.getState();
            if (!userId)
                return [];
            try {
        ...
        getProfitLossStatementView: async (startDate, endDate) => {
            const { userId } = useAuthStore.getState();
            if (!userId)
                return [];
            try {
...
export const useFinancialStore = create()(persist(financialStore, {
